 ...
 * @version 1, 0
 */
public class Imagen extends Vista {
    /**
    ...
    public Imagen(int ancho, int alto, int idPantalla, int idLayout, boolean requerido, boolean habilitado,
    ...
    public Imagen(int id, int ancho, int alto, int idPantalla, int idLayout, boolean requerido,
    ...
    @Override
    public Vista clone() {
        return new  Imagen(id, ancho, alto, idPantalla, idLayout, requerido,
