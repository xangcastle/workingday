...
/**
 * Representa un campo de TextArea en el formulario
 * @version 1.0
 */
public class TextArea extends Vista{
    /**
    ...
    public TextArea(int ancho, int alto, int idPantalla, int idLayout, boolean requerido
    ...
    public TextArea(int id, int ancho, int alto, int idPantalla, int idLayout, boolean requerido
            ,int tipoEntrada,String valor,int longitudMaxima,String nombreVariable,String titulo,boolean habilitado) {
    ...
    public View construirVista(Context context) {
        ...
        int h=((WindowManager) context.getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getHeight() / 3;
        ...
        TextInputLayout.LayoutParams l=new TextInputLayout.LayoutParams(ancho,h);
    ...
    public Vista clone() {
        ...
        return new TextArea(id, ancho, alto, idPantalla, idLayout, requerido
    ...
    public final static class ColumnasTablaSql {
        public static final String TABLE_NAME = "TextAreas";
